...
BEGIN
	SET @SqlCmd=CONCAT('CREATE TABLE IF NOT EXISTS ',GT_DB,'.`antenna_info` (
				  `ANTENNA_MODEL` VARCHAR(100) CHARACTER SET utf8 NOT NULL DEFAULT '''',
				  `TYPE` VARCHAR(60) DEFAULT NULL,
				  `GAIN_DBI` DOUBLE DEFAULT NULL,
				  ...
				  `HORIZONTAL_360` TEXT,
				  `VERTICAL_360` TEXT,
				  `CATEGORIZE` VARCHAR(50) CHARACTER SET utf8 DEFAULT NULL,
				  ...
				  `ANTENNA_GROUP` VARCHAR(50) CHARACTER SET utf8 DEFAULT NULL,
