...
CREATE DEFINER=`covmo`@`%` PROCEDURE `SP_Generate_Global_Statistic_Sub_tile_Aggr`(IN TECH_MASK TINYINT(2),IN WORKER_ID VARCHAR(10),IN FLAG TINYINT(2),IN exDate VARCHAR(10),IN DS_FLAG TINYINT(2),IN PENDING_FLAG TINYINT(2),IN TileResolution VARCHAR(8))
BEGIN
	...
	SET @FLAG_TILE_19_UMTS_HR=0;
	SET @FLAG_TILE_19_UMTS_DY=0;
	SET @FLAG_TILE_16_UMTS_HR=0;
	SET @FLAG_TILE_16_UMTS_DY=0;
	SET @FLAG_TILE_13_UMTS_HR=0;
	SET @FLAG_TILE_13_UMTS_DY=0;
	SET @FLAG_TILE_19_UMTS_WK=0;
	SET @FLAG_TILE_19_UMTS_MN=0;
	SET @FLAG_TILE_16_UMTS_WK=0;
	SET @FLAG_TILE_16_UMTS_MN=0;
	SET @FLAG_TILE_13_UMTS_WK=0;
	SET @FLAG_TILE_13_UMTS_MN=0;
	...
	SET @FLAG_TILE_19_LTE_HR=0;
	SET @FLAG_TILE_19_LTE_DY=0;
	SET @FLAG_TILE_16_LTE_HR=0;
	SET @FLAG_TILE_16_LTE_DY=0;
	SET @FLAG_TILE_13_LTE_HR=0;
	SET @FLAG_TILE_19_LTE_WK=0;
	SET @FLAG_TILE_19_LTE_MN=0;
	SET @FLAG_TILE_16_LTE_WK=0;
	SET @FLAG_TILE_16_LTE_MN=0;
	SET @FLAG_TILE_13_LTE_WK=0;
	SET @FLAG_TILE_13_LTE_MN=0;
	SET @FLAG_TILE_13_LTE_DY=0;
	...
	SET @FLAG_TILE_19_GSM_HR=0;
	SET @FLAG_TILE_19_GSM_DY=0;
	SET @FLAG_TILE_16_GSM_HR=0;
	SET @FLAG_TILE_16_GSM_DY=0;
	SET @FLAG_TILE_13_GSM_HR=0;
	SET @FLAG_TILE_13_GSM_DY=0;
	SET @FLAG_TILE_19_GSM_WK=0;
	SET @FLAG_TILE_19_GSM_MN=0;
	SET @FLAG_TILE_16_GSM_WK=0;
	SET @FLAG_TILE_16_GSM_MN=0;
	SET @FLAG_TILE_13_GSM_WK=0;
	SET @FLAG_TILE_13_GSM_MN=0;
	...
	IF FLAG IN (1,0) THEN 
		...
		INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',@SqlCmd, START_TIME);		
		...
		BEGIN
			...
			BEGIN	
				...
				SET @tmp_tile_19_umts_hr=CONCAT('tmp_tile_',@ZOOM_LEVEL,'_umts_hr_',@EX_DATE);
				SET @tmp_tile_19_lte_hr=CONCAT('tmp_tile_',@ZOOM_LEVEL,'_lte_hr_',@EX_DATE);
				SET @tmp_tile_19_gsm_hr=CONCAT('tmp_tile_',@ZOOM_LEVEL,'_gsm_hr_',@EX_DATE);
				
				SET @tmp_tile_pu_umts_hr=CONCAT('gt_global_statistic.tmp_tile_pu_umts_',@EX_DATE);
				SET @tmp_tile_pu_lte_hr=CONCAT('gt_global_statistic.tmp_tile_pu_lte_',@EX_DATE);
				SET @tmp_tile_pu_gsm_hr=CONCAT('gt_global_statistic.tmp_tile_pu_gsm_',@EX_DATE);
				...
				SET @table_tile_19_umts_wk=CONCAT('table_tile_',@ZOOM_LEVEL,'_umts_wk_',@DATE_WK);
				SET @table_tile_19_umts_mn=CONCAT('table_tile_',@ZOOM_LEVEL,'_umts_mn_',@DATE_MN);
				
				SET @table_tile_pu_umts_dy=CONCAT('table_tile_pu_umts_dy_',@DATE_DY);
				SET @table_tile_pu_umts_wk=CONCAT('table_tile_pu_umts_wk_',@DATE_WK);
				SET @table_tile_pu_umts_mn=CONCAT('table_tile_pu_umts_mn_',@DATE_MN);
				...
				SET @table_tile_19_lte_wk=CONCAT('table_tile_',@ZOOM_LEVEL,'_lte_wk_',@DATE_WK);
				SET @table_tile_19_lte_mn=CONCAT('table_tile_',@ZOOM_LEVEL,'_lte_mn_',@DATE_MN);
				
				SET @table_tile_pu_lte_dy=CONCAT('table_tile_pu_lte_dy_',@DATE_DY);
				SET @table_tile_pu_lte_wk=CONCAT('table_tile_pu_lte_wk_',@DATE_WK);
				SET @table_tile_pu_lte_mn=CONCAT('table_tile_pu_lte_mn_',@DATE_MN);
				...
				SET @table_tile_19_gsm_wk=CONCAT('table_tile_',@ZOOM_LEVEL,'_gsm_wk_',@DATE_WK);
				SET @table_tile_19_gsm_mn=CONCAT('table_tile_',@ZOOM_LEVEL,'_gsm_mn_',@DATE_MN);
				
				SET @table_tile_pu_gsm_dy=CONCAT('table_tile_pu_gsm_dy_',@DATE_DY);
				SET @table_tile_pu_gsm_wk=CONCAT('table_tile_pu_gsm_wk_',@DATE_WK);
				SET @table_tile_pu_gsm_mn=CONCAT('table_tile_pu_gsm_mn_',@DATE_MN);
				...
				IF v_TECH_MASK=2 THEN 
					SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@tmp_tile_19_umts_hr,';');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
		
					SET @SqlCmd=CONCAT('CREATE TABLE ',SHARE_DB,'.',@tmp_tile_19_umts_hr,' LIKE ',@global_db,'.tmp_tile_umts_',@EX_DATE,';');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
	
					SET @SOURCE_TABLE_NAME=@tmp_tile_19_umts_hr;
					SET @ERROR_FLAG='10_tmp_tile_19_umts_hr_1';
					
					SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@tmp_tile_19_umts_hr,' 
							    (`TILE_ID`,
							     `FREQUENCY`,
							     `UARFCN`,
							     `DATA_DATE`,
							...
							FROM ',@global_db,'.tmp_tile_umts_',@EX_DATE,' 
					...
					CALL gt_global_statistic.SP_Generate_Global_Statistic_Sub_Tile_Reg_Map(CONCAT(SHARE_DB,'.',@tmp_tile_19_umts_hr),WORKER_ID,0,gt_strtok(@REG_GROUP, @v_reg_m, '|'));
					...
					IF FLAG IN (0,1) THEN 	
						...
						SET @SqlCmd=CONCAT('CREATE TABLE ',SHARE_DB,'.',@table_tile_19_umts_hr,' LIKE ',v_group_db_name,'.',@table_tile_19_umts_hr,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
	
						SET @SOURCE_TABLE_NAME=@table_tile_19_umts_hr;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_umts_hr);					
						SET @ERROR_FLAG='10_tile_19_umts_hr_2';
	
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_umts_hr,'
								    (`TILE_ID`,
								     `FREQUENCY`,
								     `UARFCN`,
								     `DATA_DATE`,
								...
								FROM ',SHARE_DB,'.',@tmp_tile_19_umts_hr
								,CASE PENDING_FLAG WHEN 1 THEN 
									CONCAT(' ON DUPLICATE KEY UPDATE ',REPLACE(TILE_UMTS_COLUMN_UPD_STR,'RPT_TABLE_NAME',CONCAT(SHARE_DB,'.',@table_tile_19_umts_hr)))
									ELSE '' END
								,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						...
						SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_19_umts_hr,'#P#h',v_DATA_HOUR,'.');
						...
						SET @FLAG_TILE_19_UMTS_HR=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_hr,', cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_umts_hr,@tmp_tile_19_umts_hr,'HR',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_hr,' HR cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_UMTS_HR=1;
						SET @FLAG_TILE_13_UMTS_HR=1;
						...
						SET @ERROR_FLAG='10_reg_3_umts_hr_3';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_umts_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						...
						SET @ERROR_FLAG='10_reg_2_umts_hr_4';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_umts_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						...
						SET @ERROR_FLAG='10_reg_1_umts_hr_5';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_umts_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						SET @SOURCE_TABLE_NAME=@table_tile_19_umts_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_umts_dy);
						SET @ERROR_FLAG='10_tile_19_umts_dy_mv_6';
						...
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_umts_dy,' 
									(`TILE_ID`,
									`FREQUENCY`,
									`UARFCN`,
									`DATA_DATE`,
									...
									',REPLACE(TILE_UMTS_COLUMN_UPD_STR,'RPT_TABLE_NAME',@table_tile_19_umts_dy),',
									',@table_tile_19_umts_dy,'.',@TILE_ID_LVL2,'=IF(',@table_tile_19_umts_dy,'.',@TILE_ID_LVL2,' IS NULL,VALUES(',@TILE_ID_LVL2,'),',@table_tile_19_umts_dy,'.',@TILE_ID_LVL2,'),
									',@table_tile_19_umts_dy,'.',@TILE_ID_LVL1,'=IF(',@table_tile_19_umts_dy,'.',@TILE_ID_LVL1,' IS NULL,VALUES(',@TILE_ID_LVL1,'),',@table_tile_19_umts_dy,'.',@TILE_ID_LVL1,'),
									',@table_tile_19_umts_dy,'.REG_1_ID=IF(',@table_tile_19_umts_dy,'.REG_1_ID IS NULL,VALUES(REG_1_ID),',@table_tile_19_umts_dy,'.REG_1_ID),
									',@table_tile_19_umts_dy,'.REG_2_ID=IF(',@table_tile_19_umts_dy,'.REG_2_ID IS NULL,VALUES(REG_2_ID),',@table_tile_19_umts_dy,'.REG_2_ID),
									',@table_tile_19_umts_dy,'.REG_3_ID=IF(',@table_tile_19_umts_dy,'.REG_3_ID IS NULL,VALUES(REG_3_ID),',@table_tile_19_umts_dy,'.REG_3_ID)
									;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_UMTS_DY=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_umts_dy,@tmp_tile_19_umts_hr,'DY',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_dy,' DY cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_UMTS_DY=1;
						SET @FLAG_TILE_13_UMTS_DY=1;	
						
						SET @SOURCE_TABLE_NAME=@table_reg_3_umts_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_umts_dy);
						SET @ERROR_FLAG='10_reg_3_umts_dy_mv_7';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_umts_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						SET @SOURCE_TABLE_NAME=@table_reg_2_umts_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_umts_dy);						SET @ERROR_FLAG='10_reg_2_umts_dy_mv_8';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_umts_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						SET @SOURCE_TABLE_NAME=@table_reg_1_umts_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_umts_dy);
						SET @ERROR_FLAG='10_reg_1_umts_dy_mv_9';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_umts_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE(); 
	
						SET @SOURCE_TABLE_NAME=@table_tile_pu_umts_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_umts_dy);
						SET @ERROR_FLAG='10_tile_pu_umts_dy_mv_10';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_umts_dy,' 
								    (',TILE_PU_MAPPING_COLUMN_STR,')
									SELECT 
									  ',TILE_PU_MAPPING_COLUMN_STR,' 
									FROM ',@tmp_tile_pu_umts_hr,' 
									;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_PU_UMTS_DY=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_umts_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
					END IF;
		
					IF FLAG = 0 THEN 
						SET @SOURCE_TABLE_NAME=@table_tile_19_umts_wk;
						SET @REPAIR_TABLE_NAME=CONCAT('',v_group_db_name,'.',@table_tile_19_umts_wk,'');
						SET @ERROR_FLAG='10_tile_19_umts_wk_11';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_umts_wk,' 
								    (`TILE_ID`,
								     `FREQUENCY`,
								     `UARFCN`,
								     ',TILE_UMTS_COLUMN_STR,')
								...
								FROM ',SHARE_DB,'.',@tmp_tile_19_umts_hr,' 
								ON DUPLICATE KEY UPDATE 
								',REPLACE(TILE_UMTS_COLUMN_UPD_STR,'RPT_TABLE_NAME',CONCAT(SHARE_DB,'.',@table_tile_19_umts_wk)),'
								;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_UMTS_WK=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_wk,', cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_umts_wk,@tmp_tile_19_umts_hr,'WK',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_wk,' WK cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_UMTS_WK=1;
						SET @FLAG_TILE_13_UMTS_WK=1;
						
						SET @SOURCE_TABLE_NAME=@table_reg_3_umts_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_umts_wk);
						SET @ERROR_FLAG='10_reg_3_umts_wk_12';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_umts_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
										
						SET @SOURCE_TABLE_NAME=@table_reg_2_umts_wk;	
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_umts_wk);
						SET @ERROR_FLAG='10_reg_2_umts_wk_13';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_umts_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_1_umts_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_umts_wk);
						SET @ERROR_FLAG='10_reg_1_umts_wk_14';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_umts_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_tile_pu_umts_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_umts_wk);
						SET @ERROR_FLAG='10_tile_pu_umts_wk_15';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);				
				
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_umts_wk,' 
								    (',TILE_PU_MAPPING_COLUMN_STR,')
								SELECT 
								  ',TILE_PU_MAPPING_COLUMN_STR,' 
								FROM ',@tmp_tile_pu_umts_hr,' 
						...
						SET @FLAG_TILE_PU_UMTS_WK=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_umts_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_tile_19_umts_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_umts_mn);
						SET @ERROR_FLAG='10_tile_19_umts_mn_16';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_umts_mn,' 
								    (`TILE_ID`,
								     `FREQUENCY`,
								     `UARFCN`,
								     ',TILE_UMTS_COLUMN_STR,')
								...
								FROM ',SHARE_DB,'.',@tmp_tile_19_umts_hr,' 
								ON DUPLICATE KEY UPDATE 
								',REPLACE(TILE_UMTS_COLUMN_UPD_STR,'RPT_TABLE_NAME',CONCAT(SHARE_DB,'.',@table_tile_19_umts_mn)),'
								;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_UMTS_MN=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_umts_mn,@tmp_tile_19_umts_hr,'MN',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_mn,' MN cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_UMTS_MN=1;
						SET @FLAG_TILE_13_UMTS_MN=1;
						
						SET @SOURCE_TABLE_NAME=@table_reg_3_umts_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_umts_mn);
						SET @ERROR_FLAG='10_reg_3_umts_mn_17';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_umts_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
								
						SET @SOURCE_TABLE_NAME=@table_reg_2_umts_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_umts_mn);
						SET @ERROR_FLAG='10_reg_2_umts_mn_18';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_umts_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_1_umts_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_umts_mn);
						SET @ERROR_FLAG='10_reg_1_umts_mn_19';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_umts_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_tile_pu_umts_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_umts_mn);
						SET @ERROR_FLAG='10_tile_pu_umts_mn_20';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_umts_mn,' 
								    (',TILE_PU_MAPPING_COLUMN_STR,')
								SELECT 
								  ',TILE_PU_MAPPING_COLUMN_STR,' 
								FROM ',@tmp_tile_pu_umts_hr,' 
						...
						SET @FLAG_TILE_PU_UMTS_MN=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_umts_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
					END IF;
					...
					SET @SqlCmd=CONCAT('UPDATE `gt_global_statistic`.tmp_table_call_cnt_',WORKER_ID,' A
						SET 
						  A.`FLAG_TILE_19_HR` = ',@FLAG_TILE_19_UMTS_HR,',
						  A.`FLAG_TILE_19_DY` = ',@FLAG_TILE_19_UMTS_DY,',
						  A.`FLAG_TILE_16_HR` = ',@FLAG_TILE_16_UMTS_HR,',
						  A.`FLAG_TILE_16_DY` = ',@FLAG_TILE_16_UMTS_DY,',
						  A.`FLAG_TILE_13_HR` = ',@FLAG_TILE_13_UMTS_HR,',
						  A.`FLAG_TILE_13_DY` = ',@FLAG_TILE_13_UMTS_DY,',
						  A.`FLAG_TILE_19_WK` = ',@FLAG_TILE_19_UMTS_WK,',
						  A.`FLAG_TILE_19_MN` = ',@FLAG_TILE_19_UMTS_MN,',
						  A.`FLAG_TILE_16_WK` = ',@FLAG_TILE_16_UMTS_WK,',
						  A.`FLAG_TILE_16_MN` = ',@FLAG_TILE_16_UMTS_MN,',
						  A.`FLAG_TILE_13_WK` = ',@FLAG_TILE_13_UMTS_WK,',
						  A.`FLAG_TILE_13_MN` = ',@FLAG_TILE_13_UMTS_MN,', 
					...
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
					INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('UMTS SELECT COUNT(*),TRUE,',WORKER_ID,' - ',gt_strtok(@REG_GROUP, @v_reg_m, '|'),' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				END IF;
		
				IF v_TECH_MASK=1 THEN 
					SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@tmp_tile_19_gsm_hr,';');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
		
					SET @SqlCmd=CONCAT('CREATE TABLE ',SHARE_DB,'.',@tmp_tile_19_gsm_hr,' LIKE ',@global_db,'.tmp_tile_gsm_',@EX_DATE,';');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
	
					SET @SOURCE_TABLE_NAME=@tmp_tile_19_gsm_hr;
					SET @ERROR_FLAG='10_tmp_tile_19_gsm_hr_21';
					
					SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@tmp_tile_19_gsm_hr,' 
							    (`TILE_ID`,
							     `FREQUENCY`,
							     `BCCH_ARFCN`,
							     `DATA_DATE`,
						...
						FROM ',@global_db,'.tmp_tile_gsm_',@EX_DATE,' 
						WHERE `TILE_ID`>0 AND `TILE_ID` IS NOT NULL
						GROUP BY `TILE_ID`,`FREQUENCY`,`BCCH_ARFCN`,`DATA_DATE`,`DATA_HOUR`
						ORDER BY NULL
						;');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					...
					CALL gt_global_statistic.SP_Generate_Global_Statistic_Sub_Tile_Reg_Map(CONCAT(SHARE_DB,'.',@tmp_tile_19_gsm_hr),WORKER_ID,0,gt_strtok(@REG_GROUP, @v_reg_m, '|'));
					...
					IF FLAG IN (0,1) THEN 
						...
						SET @SqlCmd=CONCAT('CREATE TABLE ',SHARE_DB,'.',@table_tile_19_gsm_hr,' LIKE ',v_group_db_name,'.',@table_tile_19_gsm_hr,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
	
						SET @SOURCE_TABLE_NAME=@table_tile_19_gsm_hr;						
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_gsm_hr);	
						SET @ERROR_FLAG='10_tile_19_gsm_hr_22';
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_gsm_hr,'
								    (`TILE_ID`,
								     `FREQUENCY`,
								     `BCCH_ARFCN`,
								     `DATA_DATE`,
								...
								FROM ',SHARE_DB,'.',@tmp_tile_19_gsm_hr
								,CASE PENDING_FLAG WHEN 1 THEN 
									CONCAT(' ON DUPLICATE KEY UPDATE ',REPLACE(TILE_GSM_COLUMN_UPD_STR,'RPT_TABLE_NAME',@table_tile_19_gsm_hr))
									ELSE '' END
								,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						...
						SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_19_gsm_hr,'#P#h',v_DATA_HOUR,'.');
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_mv`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@table_tile_19_gsm_hr,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						...
						SET @FLAG_TILE_19_gsm_HR=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_hr,', cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_gsm_hr,@tmp_tile_19_gsm_hr,'HR',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_hr,' HR cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_gsm_HR=1;
						SET @FLAG_TILE_13_gsm_HR=1;
						...
						SET @ERROR_FLAG='10_reg_3_gsm_hr_23';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_gsm_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						...
						SET @ERROR_FLAG='10_reg_2_gsm_hr_24';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_gsm_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						...
						SET @ERROR_FLAG='10_reg_1_gsm_hr_25';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_gsm_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
		
						SET @SOURCE_TABLE_NAME=@table_tile_19_gsm_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_gsm_dy);						
						SET @ERROR_FLAG='10_tile_19_gsm_dy_mv_26';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_gsm_dy,' 
								    (`TILE_ID`,
								     `FREQUENCY`,
								     `BCCH_ARFCN`,
								     `DATA_DATE`,
								...
								FROM ',SHARE_DB,'.',@tmp_tile_19_gsm_hr,' 
								ON DUPLICATE KEY UPDATE 
								',REPLACE(TILE_GSM_COLUMN_UPD_STR,'RPT_TABLE_NAME',@table_tile_19_gsm_dy),',
								',@table_tile_19_gsm_dy,'.',@TILE_ID_LVL2,' =IF(',@table_tile_19_gsm_dy,'.',@TILE_ID_LVL2,' IS NULL,VALUES(',@TILE_ID_LVL2,'),',@table_tile_19_gsm_dy,'.',@TILE_ID_LVL2,'),
								',@table_tile_19_gsm_dy,'.',@TILE_ID_LVL1,' =IF(',@table_tile_19_gsm_dy,'.',@TILE_ID_LVL1,' IS NULL,VALUES(',@TILE_ID_LVL1,'),',@table_tile_19_gsm_dy,'.',@TILE_ID_LVL1,'),
								',@table_tile_19_gsm_dy,'.REG_1_ID =IF(',@table_tile_19_gsm_dy,'.REG_1_ID IS NULL,VALUES(REG_1_ID),',@table_tile_19_gsm_dy,'.REG_1_ID),
								',@table_tile_19_gsm_dy,'.REG_2_ID =IF(',@table_tile_19_gsm_dy,'.REG_2_ID IS NULL,VALUES(REG_2_ID),',@table_tile_19_gsm_dy,'.REG_2_ID),
								',@table_tile_19_gsm_dy,'.REG_3_ID =IF(',@table_tile_19_gsm_dy,'.REG_3_ID IS NULL,VALUES(REG_3_ID),',@table_tile_19_gsm_dy,'.REG_3_ID)
								;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_gsm_DY=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();	
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_gsm_dy,@tmp_tile_19_gsm_hr,'DY',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_dy_mv,' DY cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_gsm_DY=1;
						SET @FLAG_TILE_13_gsm_DY=1;	
	
						SET @SOURCE_TABLE_NAME=@table_reg_3_gsm_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_gsm_dy);
						SET @ERROR_FLAG='10_reg_3_gsm_dy_mv_27';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);				
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_gsm_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_2_gsm_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_gsm_dy);						
						SET @ERROR_FLAG='10_reg_2_gsm_dy_mv_28';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_gsm_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						SET @SOURCE_TABLE_NAME=@table_reg_1_gsm_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_gsm_dy);						
						SET @ERROR_FLAG='10_reg_1_gsm_dy_mv_29';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_gsm_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE(); 
						
						SET @SOURCE_TABLE_NAME=@table_tile_pu_gsm_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_gsm_dy);					
						SET @ERROR_FLAG='10_tile_pu_gsm_dy_mv_30';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_gsm_dy,' 
								    (',TILE_PU_MAPPING_COLUMN_STR,')
									SELECT 
									  ',TILE_PU_MAPPING_COLUMN_STR,' 
									FROM ',@tmp_tile_pu_gsm_hr,' 
									;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_PU_GSM_DY=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_gsm_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
					END IF;
					IF FLAG = 0 THEN 	
						SET @SOURCE_TABLE_NAME=@table_tile_19_gsm_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_gsm_wk);
						SET @ERROR_FLAG='10_tile_19_gsm_wk_31';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						SET @FLAG_TILE_19_gsm_WK=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_wk,', cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_gsm_wk,@tmp_tile_19_gsm_hr,'WK',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_wk,' WK cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						SET @FLAG_TILE_16_gsm_WK=1;
						SET @FLAG_TILE_13_gsm_WK=1;				
						
						SET @SOURCE_TABLE_NAME=@table_reg_3_gsm_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_gsm_wk);
						SET @ERROR_FLAG='10_reg_3_gsm_wk_32';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_gsm_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_2_gsm_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_gsm_wk);
						SET @ERROR_FLAG='10_reg_2_gsm_wk_33';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_gsm_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_1_gsm_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_gsm_wk);
						SET @ERROR_FLAG='10_reg_1_gsm_wk_34';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_gsm_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
								
						SET @SOURCE_TABLE_NAME=@table_tile_pu_gsm_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_gsm_wk);
						SET @ERROR_FLAG='10_tile_pu_gsm_wk_35';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_gsm_wk,' 
								    (',TILE_PU_MAPPING_COLUMN_STR,')
									SELECT 
									  ',TILE_PU_MAPPING_COLUMN_STR,' 
									FROM ',@tmp_tile_pu_gsm_hr,' 
						...
						SET @FLAG_TILE_PU_GSM_WK=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_gsm_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE(); 
						
						SET @SOURCE_TABLE_NAME=@table_tile_19_gsm_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_gsm_mn);
						SET @ERROR_FLAG='10_tile_19_gsm_mn_36';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_gsm_mn,' 
								    (`TILE_ID`,
								     `FREQUENCY`,
								     `BCCH_ARFCN`,
								     ',TILE_GSM_COLUMN_STR,')
								...
								ORDER BY NULL
								ON DUPLICATE KEY UPDATE 
								',REPLACE(TILE_GSM_COLUMN_UPD_STR,'RPT_TABLE_NAME',CONCAT(SHARE_DB,'.',@table_tile_19_gsm_mn)),'
								;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_gsm_MN=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_gsm_mn,@tmp_tile_19_gsm_hr,'MN',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_mn,' MN cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @FLAG_TILE_16_gsm_MN=1;
						SET @FLAG_TILE_13_gsm_MN=1;	
						
						SET @SOURCE_TABLE_NAME=@table_reg_3_gsm_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_gsm_mn);
						SET @ERROR_FLAG='10_reg_3_gsm_mn_37';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_gsm_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_2_gsm_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_gsm_mn);
						SET @ERROR_FLAG='10_reg_2_gsm_mn_38';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_gsm_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_1_gsm_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_gsm_mn);
						SET @ERROR_FLAG='10_reg_1_gsm_mn_39';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_gsm_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE(); 
						
						SET @SOURCE_TABLE_NAME=@table_tile_pu_gsm_mn;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_gsm_mn);
						SET @ERROR_FLAG='10_tile_pu_gsm_mn_40';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_gsm_mn,' 
								    (',TILE_PU_MAPPING_COLUMN_STR,')
									SELECT 
									  ',TILE_PU_MAPPING_COLUMN_STR,' 
									FROM ',@tmp_tile_pu_gsm_hr,' 
						...
						SET @FLAG_TILE_PU_GSM_MN=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_gsm_mn,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
 						SET STEP_START_TIME := SYSDATE();
					END IF;
					...
					SET @SqlCmd=CONCAT('UPDATE `gt_global_statistic`.tmp_table_call_cnt_',WORKER_ID,' A
						SET 
						  A.`FLAG_TILE_19_HR` = ',@FLAG_TILE_19_gsm_HR,',
						  A.`FLAG_TILE_19_DY` = ',@FLAG_TILE_19_gsm_DY,',
						  A.`FLAG_TILE_16_HR` = ',@FLAG_TILE_16_gsm_HR,',
						  A.`FLAG_TILE_16_DY` = ',@FLAG_TILE_16_gsm_DY,',
						  A.`FLAG_TILE_13_HR` = ',@FLAG_TILE_13_gsm_HR,',
						  A.`FLAG_TILE_13_DY` = ',@FLAG_TILE_13_gsm_DY,',
						  A.`FLAG_TILE_19_WK` = ',@FLAG_TILE_19_gsm_WK,',
						  A.`FLAG_TILE_19_MN` = ',@FLAG_TILE_19_gsm_MN,',
						  A.`FLAG_TILE_16_WK` = ',@FLAG_TILE_16_gsm_WK,',
						  A.`FLAG_TILE_16_MN` = ',@FLAG_TILE_16_gsm_MN,',
						  A.`FLAG_TILE_13_WK` = ',@FLAG_TILE_13_gsm_WK,',
						  A.`FLAG_TILE_13_MN` = ',@FLAG_TILE_13_gsm_MN,', 
					...
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
					INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('GSM SELECT COUNT(*),TRUE,',WORKER_ID,' - ',gt_strtok(@REG_GROUP, @v_reg_m, '|'),' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				END IF;	
				
				IF v_TECH_MASK=4 THEN
					SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@tmp_tile_19_lte_hr,';');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;	
		
					SET @SqlCmd=CONCAT('CREATE TABLE ',SHARE_DB,'.',@tmp_tile_19_lte_hr,' LIKE ',@global_db,'.tmp_tile_lte_',@EX_DATE,' ;');
					PREPARE Stmt FROM @SqlCmd;
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
	
					SET @SOURCE_TABLE_NAME=@tmp_tile_19_lte_hr;
					SET @ERROR_FLAG='10_tmp_tile_19_lte_hr_41';
					
					SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@tmp_tile_19_lte_hr,' 
								(
								`TILE_ID`,
								`EARFCN`,
								`EUTRABAND`,
							...
							SELECT
								...
								`REG_2_ID`,
								`REG_3_ID`
							FROM ',@global_db,'.tmp_tile_lte_',@EX_DATE,' 
					...
					CALL gt_global_statistic.SP_Generate_Global_Statistic_Sub_Tile_Reg_Map(CONCAT(SHARE_DB,'.',@tmp_tile_19_lte_hr),WORKER_ID,0,gt_strtok(@REG_GROUP, @v_reg_m, '|'));
					IF FLAG IN (0,1) THEN 
						...
						SET @SqlCmd=CONCAT('CREATE TABLE ',SHARE_DB,'.',@table_tile_19_lte_hr,' LIKE ',v_group_db_name,'.',@table_tile_19_lte_hr,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
	
						SET @SOURCE_TABLE_NAME=@table_tile_19_lte_hr;						
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_lte_hr);
						SET @ERROR_FLAG='10_tile_19_lte_hr_42';
	
						SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_19_lte_hr,'#P#h',v_DATA_HOUR,'.');
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_mv`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@table_tile_19_lte_hr,';');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						...
						SET @FLAG_TILE_19_LTE_HR=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
					--	CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_lte_hr,@tmp_tile_19_lte_hr,'HR',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_hr,' HR cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @FLAG_TILE_16_LTE_HR=1;
						SET @FLAG_TILE_13_LTE_HR=1;
						...
						SET @ERROR_FLAG='10_reg_3_lte_hr_43';
						...
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_reg_3_lte_hr,'
								...
								SELECT
									...
									`DATA_HOUR`,
									',TILE_LTE_COLUMN_SUM_STR,'
								FROM ',SHARE_DB,'.',@tmp_tile_19_lte_hr,'
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_lte_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						...
						SET @ERROR_FLAG='10_reg_2_lte_hr_44';
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_lte_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						...
						SET @ERROR_FLAG='10_reg_1_lte_hr_45';
		...
		-- 				SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_reg_1_lte_hr,'
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_lte_hr,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();	
						
						SET @SOURCE_TABLE_NAME=@table_tile_19_lte_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_lte_dy);	
						SET @ERROR_FLAG='10_tile_19_lte_dy_mv_46';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_lte_dy,' 
								    (
									`TILE_ID`,
									`EARFCN`,
									`EUTRABAND`,
								...
								FROM ',SHARE_DB,'.',@tmp_tile_19_lte_hr,' 
								ON DUPLICATE KEY UPDATE 
								',REPLACE(TILE_LTE_COLUMN_UPD_STR,'RPT_TABLE_NAME',@table_tile_19_lte_dy),',
								',@table_tile_19_lte_dy,'.REG_1_ID=IF(',@table_tile_19_lte_dy,'.REG_1_ID IS NULL,VALUES(REG_1_ID),',@table_tile_19_lte_dy,'.REG_1_ID),
								',@table_tile_19_lte_dy,'.REG_2_ID=IF(',@table_tile_19_lte_dy,'.REG_2_ID IS NULL,VALUES(REG_2_ID),',@table_tile_19_lte_dy,'.REG_2_ID),
								',@table_tile_19_lte_dy,'.REG_3_ID=IF(',@table_tile_19_lte_dy,'.REG_3_ID IS NULL,VALUES(REG_3_ID),',@table_tile_19_lte_dy,'.REG_3_ID),
								',@table_tile_19_lte_dy,'.',@TILE_ID_LVL2,'=IF(',@table_tile_19_lte_dy,'.',@TILE_ID_LVL2,' IS NULL,VALUES(',@TILE_ID_LVL2,'),',@table_tile_19_lte_dy,'.',@TILE_ID_LVL2,'),
								',@table_tile_19_lte_dy,'.',@TILE_ID_LVL1,'=IF(',@table_tile_19_lte_dy,'.',@TILE_ID_LVL1,' IS NULL,VALUES(',@TILE_ID_LVL1,'),',@table_tile_19_lte_dy,'.',@TILE_ID_LVL1,')
								;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_lte_dy=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_lte_dy,@tmp_tile_19_lte_hr,'DY',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_dy,' DY cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
	
						SET @SOURCE_TABLE_NAME=@table_reg_3_lte_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_lte_dy);	
						SET @ERROR_FLAG='10_reg_3_lte_dy_mv_47';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @FLAG_TILE_16_lte_dy=1;
						SET @FLAG_TILE_13_lte_dy=1;
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_lte_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();	
	
						SET @SOURCE_TABLE_NAME=@table_reg_2_lte_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_lte_dy);
						SET @ERROR_FLAG='10_reg_2_lte_dy_mv_48';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_lte_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();			
								
						SET @SOURCE_TABLE_NAME=@table_reg_1_lte_dy;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_lte_dy);
						SET @ERROR_FLAG='10_reg_1_lte_dy_mv_49';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_lte_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_tile_pu_lte_dy;
						SET @REPAIR_TABLE_NAME=@table_tile_pu_lte_dy;
						SET @ERROR_FLAG='10_tile_pu_lte_dy_mv_50';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_lte_dy,'
									SELECT 
									  ',TILE_PU_MAPPING_COLUMN_STR,' 
									FROM ',@tmp_tile_pu_lte_hr,' 
									;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_PU_LTE_DY=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_lte_dy,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
					END IF; 
		
					IF FLAG =0 THEN 
						SET @SOURCE_TABLE_NAME=@table_tile_19_lte_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_lte_wk);
						SET @ERROR_FLAG='10_tile_19_lte_wk_51';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT INTO ',SHARE_DB,'.',@table_tile_19_lte_wk,' 
								    (
									`TILE_ID`,
									`EARFCN`,
									`EUTRABAND`,
							...
							FROM ',SHARE_DB,'.',@tmp_tile_19_lte_hr,' 
							ON DUPLICATE KEY UPDATE  
							',REPLACE(TILE_LTE_COLUMN_UPD_STR,'RPT_TABLE_NAME',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk)),',
							',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_1_ID=IF(',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_1_ID IS NULL,VALUES(REG_1_ID),',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_1_ID),
							',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_2_ID=IF(',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_2_ID IS NULL,VALUES(REG_2_ID),',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_2_ID),
							',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_3_ID=IF(',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_3_ID IS NULL,VALUES(REG_3_ID),',CONCAT(SHARE_DB,'.',@table_tile_19_lte_wk),'.REG_3_ID)
							;');
						PREPARE Stmt FROM @SqlCmd;
						EXECUTE Stmt;
						DEALLOCATE PREPARE Stmt;
						...
						SET @FLAG_TILE_19_lte_wk=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_lte_wk,@tmp_tile_19_lte_hr,'WK',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_wk,' WK cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();						
						
						SET @FLAG_TILE_16_lte_wk=1;
						SET @FLAG_TILE_13_lte_wk=1;
								
						SET @SOURCE_TABLE_NAME=@table_reg_3_lte_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_lte_wk);
						SET @ERROR_FLAG='10_tile_reg_3_lte_wk_52';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_3_lte_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
						
						SET @SOURCE_TABLE_NAME=@table_reg_2_lte_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_lte_wk);
						SET @ERROR_FLAG='10_tile_reg_2_lte_wk_53';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_2_lte_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
								
						SET @SOURCE_TABLE_NAME=@table_reg_1_lte_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_lte_wk);
						SET @ERROR_FLAG='10_tile_reg_1_lte_wk_54';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						...
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_reg_1_lte_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
						SET STEP_START_TIME := SYSDATE();
								
						SET @SOURCE_TABLE_NAME=@table_tile_pu_lte_wk;
						SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_lte_wk);
						SET @ERROR_FLAG='10_tile_pu_lte_wk_55';
						CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
						SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_lte_wk,'
									SELECT 
									  ',TILE_PU_MAPPING_COLUMN_STR,' 
									FROM ',@tmp_tile_pu_lte_hr,' 
									;');
						...
						SET @FLAG_TILE_PU_LTE_WK=1;
						INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_pu_lte_wk,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
	-- 					SET STEP_START_TIME := SYSDATE();
					END IF;
					...
					SET @SqlCmd=CONCAT('UPDATE `gt_global_statistic`.tmp_table_call_cnt_',WORKER_ID,' A
								SET 
								  A.`FLAG_TILE_19_HR` = ',@FLAG_TILE_19_LTE_HR,',
								  A.`FLAG_TILE_19_DY` = ',@FLAG_TILE_19_LTE_DY,',
								  A.`FLAG_TILE_16_HR` = ',@FLAG_TILE_16_LTE_HR,',
								  A.`FLAG_TILE_16_DY` = ',@FLAG_TILE_16_LTE_DY,',
								  A.`FLAG_TILE_13_HR` = ',@FLAG_TILE_13_LTE_HR,',
								  A.`FLAG_TILE_13_DY` = ',@FLAG_TILE_13_LTE_DY,',
								  A.`FLAG_TILE_19_WK` = ',@FLAG_TILE_19_LTE_WK,',
								  A.`FLAG_TILE_19_MN` = ',@FLAG_TILE_19_LTE_MN,',
								  A.`FLAG_TILE_16_WK` = ',@FLAG_TILE_16_LTE_WK,',
								  A.`FLAG_TILE_16_MN` = ',@FLAG_TILE_16_LTE_MN,',
								  A.`FLAG_TILE_13_WK` = ',@FLAG_TILE_13_LTE_WK,',
								  A.`FLAG_TILE_13_MN` = ',@FLAG_TILE_13_LTE_MN,',
					...
					EXECUTE Stmt;
					DEALLOCATE PREPARE Stmt;
					INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('LTE update table_call_cnt_',WORKER_ID,' - ',gt_strtok(@REG_GROUP, @v_reg_m, '|'),' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				END IF;	
				SET v_i=v_i+1;
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT(v_TECH_MASK,',',WORKER_ID,',',v_i,' - ',gt_strtok(@REG_GROUP, @v_reg_m, '|')), NOW());
			END;
			END WHILE;
		...
		END WHILE;
		IF v_TECH_MASK=2 THEN 	
			SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',@tmp_tile_pu_umts_hr,';');
			PREPARE Stmt FROM @SqlCmd;
			EXECUTE Stmt;
			DEALLOCATE PREPARE Stmt;
			SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',@global_db,'.tmp_tile_umts_',@EX_DATE,';');
			PREPARE Stmt FROM @SqlCmd;
			EXECUTE Stmt;
			DEALLOCATE PREPARE Stmt;
			INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('UMTS DROP ',@global_db,'.tmp_tile_umts_',@EX_DATE,' ',WORKER_ID,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
			SET STEP_START_TIME := SYSDATE();
		END IF;			
		
		IF v_TECH_MASK=1 THEN 
			SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',@tmp_tile_pu_gsm_hr,';');					
			PREPARE Stmt FROM @SqlCmd;
			EXECUTE Stmt;
			DEALLOCATE PREPARE Stmt;
			
			SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',@global_db,'.tmp_tile_gsm_',@EX_DATE,';');
			PREPARE Stmt FROM @SqlCmd;
			EXECUTE Stmt;
			DEALLOCATE PREPARE Stmt;
			INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('GSM DROP ',@global_db,'.tmp_tile_gsm_',@EX_DATE,' ',WORKER_ID,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
			SET STEP_START_TIME := SYSDATE();			
		END IF;	
		IF v_TECH_MASK=4 THEN
			SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',@tmp_tile_pu_lte_hr,';');					
			PREPARE Stmt FROM @SqlCmd;
			EXECUTE Stmt;
			DEALLOCATE PREPARE Stmt;
			
			SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',@global_db,'.tmp_tile_lte_',@EX_DATE,';');
			PREPARE Stmt FROM @SqlCmd;
			EXECUTE Stmt;
			DEALLOCATE PREPARE Stmt;
			INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('LTE DROP ',@global_db,'.tmp_tile_lte_',@EX_DATE,' ',WORKER_ID,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
			SET STEP_START_TIME := SYSDATE();
		END IF;	
	...
	IF FLAG=2 THEN 
		...
		BEGIN			
			...
			IF TECH_MASK=2 THEN 
				...
				SET @table_tile_pu_umts_dy=CONCAT('table_tile_pu_umts_dy_',@SR_DATE);
				SET @table_tile_pu_umts_wk=CONCAT('table_tile_pu_umts_wk_',@DATE_WK);
				SET @table_tile_pu_umts_mn=CONCAT('table_tile_pu_umts_mn_',@DATE_MN);
				SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_19_umts_dy,',',@table_tile_19_umts_wk);
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_umts_wk);
				SET @ERROR_FLAG='2_tile_19_umts_wk_1';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_umts_wk,@table_tile_19_umts_dy,'WK',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_wk,' WK cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				SET STEP_START_TIME := SYSDATE();
				
				SET @SOURCE_TABLE_NAME=@table_reg_3_umts_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_umts_wk);
				SET @ERROR_FLAG='2_reg_3_umts_wk_2';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_2_umts_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_umts_wk);
				SET @ERROR_FLAG='2_reg_2_umts_wk_3';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_1_umts_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_umts_wk);
				SET @ERROR_FLAG='2_reg_1_umts_wk_4';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_pu_umts_dy,',',@table_tile_pu_umts_wk);
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_umts_wk);
				SET @ERROR_FLAG='2_tile_pu_umts_wk_5';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);				
				...
				SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_umts_wk,' 
						...
						SELECT 
						  ',TILE_PU_MAPPING_COLUMN_STR,' 
						FROM ',SHARE_DB,'.',@table_tile_pu_umts_dy,' 
						;');
				PREPARE Stmt FROM @SqlCmd;
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
				...
				SET @SOURCE_TABLE_NAME=@table_tile_19_umts_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_umts_mn);
				SET @ERROR_FLAG='2_tile_19_umts_mn_6';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_umts_mn,@table_tile_19_umts_dy,'MN',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_umts_mn,' MN cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				SET STEP_START_TIME := SYSDATE();
				...
				SET @SOURCE_TABLE_NAME=@table_reg_3_umts_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_umts_mn);
				SET @ERROR_FLAG='2_reg_3_umts_mn_7';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_2_umts_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_umts_mn);
				SET @ERROR_FLAG='2_reg_2_umts_mn_8';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_1_umts_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_umts_mn);
				SET @ERROR_FLAG='2_reg_1_umts_mn_9';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_tile_pu_umts_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_umts_mn);
				SET @ERROR_FLAG='2_tile_pu_umts_mn_10';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@table_tile_pu_umts_dy,';');
				PREPARE Stmt FROM @SqlCmd;
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
				...
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('UMTS SELECT COUNT(*),TRUE,',WORKER_ID,' cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
			END IF;
			...
			IF TECH_MASK=1 THEN 
				...
				SET @table_tile_pu_gsm_dy=CONCAT('table_tile_pu_gsm_dy_',@SR_DATE);
				SET @table_tile_pu_gsm_wk=CONCAT('table_tile_pu_gsm_wk_',@DATE_WK);
				SET @table_tile_pu_gsm_mn=CONCAT('table_tile_pu_gsm_mn_',@DATE_MN);
				SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_19_gsm_dy,',',@table_tile_19_gsm_wk);
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_gsm_wk);
				SET @ERROR_FLAG='2_tile_19_gsm_wk_11';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_gsm_wk,@table_tile_19_gsm_dy,'WK',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_wk,' WK cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				SET STEP_START_TIME := SYSDATE();
				...
				SET @SOURCE_TABLE_NAME=@table_reg_3_gsm_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_gsm_wk);
				SET @ERROR_FLAG='2_reg_3_gsm_wk_12';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_2_gsm_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_gsm_wk);
				SET @ERROR_FLAG='2_reg_2_gsm_wk_13';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_1_gsm_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_gsm_wk);
				SET @ERROR_FLAG='2_reg_1_gsm_wk_14';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_pu_gsm_dy,',',@table_tile_pu_gsm_wk);
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_gsm_wk);
				SET @ERROR_FLAG='2_tile_pu_gsm_wk_15';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_gsm_wk,' 
							...
							SELECT 
							  ',TILE_PU_MAPPING_COLUMN_STR,' 
							FROM ',SHARE_DB,'.',@table_tile_pu_gsm_dy,' 
							;');
				PREPARE Stmt FROM @SqlCmd;
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
				...
				SET @SOURCE_TABLE_NAME=@table_tile_19_gsm_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_gsm_mn);
				SET @ERROR_FLAG='2_tile_19_gsm_mn_16';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_gsm_mn,@table_tile_19_gsm_dy,'MN',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_gsm_mn,' MN cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				SET STEP_START_TIME := SYSDATE();
				...
				SET @SOURCE_TABLE_NAME=@table_reg_3_gsm_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_gsm_mn);
				SET @ERROR_FLAG='2_reg_3_gsm_mn_17';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_2_gsm_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_gsm_mn);
				SET @ERROR_FLAG='2_reg_2_gsm_mn_18';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_1_gsm_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_gsm_mn);
				SET @ERROR_FLAG='2_reg_1_gsm_mn_19';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_tile_pu_gsm_mn;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_gsm_mn);
				SET @ERROR_FLAG='2_tile_pu_gsm_mn_20';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@table_tile_pu_gsm_dy,';');
				PREPARE Stmt FROM @SqlCmd;
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
			...
			IF TECH_MASK=4 THEN
				...
				SET @table_tile_pu_lte_dy=CONCAT('table_tile_pu_lte_dy_',@SR_DATE);
				SET @table_tile_pu_lte_wk=CONCAT('table_tile_pu_lte_wk_',@DATE_WK);
				SET @table_tile_pu_lte_mn=CONCAT('table_tile_pu_lte_mn_',@DATE_MN);
				
				SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_19_lte_dy,',',@table_tile_19_lte_wk);
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_19_lte_wk);
				SET @ERROR_FLAG='2_tile_19_lte_wk_21';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_TileResolution_Insert_MV`(TECH_MASK,@table_tile_19_lte_wk,@table_tile_19_lte_dy,'WK',PENDING_FLAG,TileResolution,SHARE_DB, v_group_db_name,v_DATA_HOUR);
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT('INSERT INTO ',@table_tile_19_lte_wk,' WK cost:',TIMESTAMPDIFF(SECOND,STEP_START_TIME,SYSDATE()),' sec.'), NOW());
				SET STEP_START_TIME := SYSDATE();				
				...
				SET @SOURCE_TABLE_NAME=@table_reg_3_lte_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_3_lte_wk);
				SET @ERROR_FLAG='2_reg_3_lte_wk_22';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_2_lte_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_2_lte_wk);
				SET @ERROR_FLAG='2_reg_2_lte_wk_23';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=@table_reg_1_lte_wk;
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_reg_1_lte_wk);
				SET @ERROR_FLAG='2_reg_1_lte_wk_24';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
				...
				SET @SOURCE_TABLE_NAME=CONCAT(@table_tile_pu_lte_dy,',',@table_tile_pu_lte_wk);
				SET @REPAIR_TABLE_NAME=CONCAT(v_group_db_name,'.',@table_tile_pu_lte_wk);
				SET @ERROR_FLAG='2_tile_pu_lte_wk_25';
				CALL gt_global_statistic.`SP_Generate_Global_Statistic_db_cp`(SHARE_IP,SHARE_PORT,SHARE_ACCOUNT,SHARE_PW,v_group_db_name,SHARE_DB,@SOURCE_TABLE_NAME,WORKER_ID);
						
				SET @SqlCmd=CONCAT('INSERT IGNORE INTO ',SHARE_DB,'.',@table_tile_pu_lte_wk,'
							SELECT 
							  ',TILE_PU_MAPPING_COLUMN_STR,' 
							FROM ',SHARE_DB,'.',@table_tile_pu_lte_dy,' 
							;');
				PREPARE Stmt FROM @SqlCmd;
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
		...
		-- 		SET STEP_START_TIME := SYSDATE();
				...
				SET @SqlCmd=CONCAT('DROP TABLE IF EXISTS ',SHARE_DB,'.',@table_tile_pu_lte_dy,';');
				PREPARE Stmt FROM @SqlCmd;
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
				...
				EXECUTE Stmt;
				DEALLOCATE PREPARE Stmt;
				INSERT INTO gt_gw_main.SP_LOG VALUES(@global_db,'SP_Generate_Global_Statistic_Sub_tile_Aggr',CONCAT(v_DATA_DATE,',',v_TECH_MASK,',',WORKER_ID,' Done: ',TIMESTAMPDIFF(SECOND,START_TIME,SYSDATE()),' seconds.'), NOW());
			END IF;
			SET @v_reg_m=@v_reg_m+1;
		END;
		END WHILE;
