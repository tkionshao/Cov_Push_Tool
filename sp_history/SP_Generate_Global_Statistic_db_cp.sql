...
CREATE DEFINER=`covmo`@`%` PROCEDURE `SP_Generate_Global_Statistic_db_cp`(IN NW_IP VARCHAR(17),IN NW_PORT SMALLINT(6),IN NW_USER VARCHAR(32),IN NW_PASSWORD VARCHAR(32),IN GROUP_DB_NAME VARCHAR(100),IN GT_AGGREGATE_DB VARCHAR(100),IN SOURCE_TABLE_NAME VARCHAR(100),IN WORKER_ID VARCHAR(10))
BEGIN
