...
BEGIN	
	...
	CALL gt_gw_main.SP_Sub_Generate_Pre_NBO_Daily(GT_DB,'opt_nbr_inter_intra_lte','LTE',
		...
		'DISTANCE_METER|HO_COUNT|PINGPONG_HO_CNT|HO_FAIL_CNT|HO_RE_EST_CNT|TA_HO_SUM|TA_HO_CNT|MEAS_COUNT|RSRP_SUM|RSRQ_SUM|RSRP_CNT|RSRQ_CNT|BEST_MEAS_CNT|SERVING_RSRP_SUM|
		SERVING_RSRQ_SUM|SERVING_RSRP_CNT|SERVING_RSRQ_CNT|HO_INTERRUP_TIME|HO_INTERRUP_CNT|TARGET_TA_SUM|TARGET_TA_CNT|HO_RSRP_SUM|HO_RSRP_CNT|HO_RSRQ_SUM|HO_RSRQ_CNT|
		HO_SERVING_RSRP_SUM|HO_SERVING_RSRP_CNT|HO_SERVING_RSRQ_SUM|HO_SERVING_RSRQ_CNT',
		'DATA_DATE');
