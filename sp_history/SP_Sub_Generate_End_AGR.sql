...
-- 				,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
				,NAS_CAUSE_SM_SUM,NAS_GPRS_MM_DETACH_SUM,PDP_DEACTIVATION_REQUEST_CNT,PDP_DEACTIVATION_ACCEPT_CNT,IRAT_HHO_FAILURE
	)
				SELECT
				 DATA_DATE
				, DATA_HOUR
				...
				, SUM(IF((IU_RELEASE_CAUSE NOT IN (14,15,46,115) OR IU_RELEASE_CAUSE IS NULL) AND CALL_STATUS =2,1,0)) AS CAUSE_OTHERS_CNT
...
-- 				, SUM(IF(CALL_TYPE IN (12,13,14,18),1,0)) AS CALL_TYPE_PS
				...
				, SUM(PDP_DEACTIVATION_REQUEST) AS PDP_DEACTIVATION_REQUEST_CNT
				, SUM(PDP_DEACTIVATION_ACCEPT) AS PDP_DEACTIVATION_ACCEPT_CNT
				, SUM(IRAT_HHO_FAIL) AS IRAT_HHO_FAILURE
...
-- 						, POS_LAST_UARFCN
	...
	SET @SqlCmd=CONCAT('INSERT INTO  ',GT_DB,RUN,'.`table_tile_end`	
					(DATA_DATE,DATA_HOUR,INDOOR,MOVING,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY, UARFCN, 
					CELL_ID,CALL_TYPE,CALL_STATUS,CELL_NAME,CALL_CNT,CAUSE_14_CNT,CAUSE_15_CNT,CAUSE_46_CNT,CAUSE_115_CNT,CAUSE_OTHERS_CNT,
					CAUSE_53_CNT,CAUSE_65_CNT,CAUSE_114_CNT,CAUSE_263_CNT,
...
-- 				,SUM(CALL_TYPE_PS) AS CALL_TYPE_PS
				...
				,SUM(PDP_DEACTIVATION_REQUEST_CNT) AS PDP_DEACTIVATION_REQUEST_CNT
				,SUM(PDP_DEACTIVATION_ACCEPT_CNT) AS PDP_DEACTIVATION_ACCEPT_CNT
				,SUM(IRAT_HHO_FAILURE) AS IRAT_HHO_FAILURE
				FROM ',GT_DB,RUN,'.`tmp_table_tile_end_',WORKER_ID,'`
...
-- 						, UARFCN
	...
	SET @SqlCmd=CONCAT('INSERT INTO  ',GT_DB,RUN,'.`table_tile_end_def`
				(DATA_DATE,DATA_HOUR,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN, 
				CELL_ID,CELL_NAME,CALL_CNT,CAUSE_14_CNT,CAUSE_15_CNT,CAUSE_46_CNT,CAUSE_115_CNT,CAUSE_OTHERS_CNT,
				CAUSE_53_CNT,CAUSE_65_CNT,CAUSE_114_CNT,CAUSE_263_CNT,CAUSE_CAPACITY,
				BEST_RSCP_1,BEST_ECN0_1,BEST_RSCP_1_MED,BEST_ECN0_1_MED,IRAT_HHO_ATTEMPT,IRAT_HHO_SUCCESS, CELL_LON,CELL_LAT,POS_LAST_RSCP_CNT,POS_LAST_ECN0_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 				,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
...
-- 				,SUM(CALL_TYPE_PS) AS CALL_TYPE_PS
	...
	SET @SqlCmd=CONCAT('INSERT INTO  ',GT_DB,RUN,'.`table_tile_end_c_def`
				(DATA_DATE,DATA_HOUR,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,
				CELL_ID,CELL_NAME,CALL_CNT,CAUSE_14_CNT,CAUSE_15_CNT,CAUSE_46_CNT,CAUSE_115_CNT,CAUSE_OTHERS_CNT,
				CAUSE_53_CNT,CAUSE_65_CNT,CAUSE_114_CNT,CAUSE_263_CNT,CAUSE_CAPACITY,
				BEST_RSCP_1,BEST_ECN0_1,BEST_RSCP_1_MED,BEST_ECN0_1_MED,IRAT_HHO_ATTEMPT,IRAT_HHO_SUCCESS, CELL_LON,CELL_LAT,POS_LAST_RSCP_CNT,POS_LAST_ECN0_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
...
-- 			, CASE WHEN A.CALL_TYPE_PS IS NULL AND B.CALL_TYPE_PS IS NULL THEN NULL ELSE IFNULL(A.CALL_TYPE_PS,0) + IFNULL(B.CALL_TYPE_PS,0) END AS CALL_TYPE_PS
			...
			, CASE WHEN A.PDP_DEACTIVATION_REQUEST_CNT IS NULL AND B.PDP_DEACTIVATION_REQUEST_CNT IS NULL THEN NULL ELSE IFNULL(A.PDP_DEACTIVATION_REQUEST_CNT,0) + IFNULL(B.PDP_DEACTIVATION_REQUEST_CNT,0) END AS PDP_DEACTIVATION_REQUEST_CNT
			, CASE WHEN A.PDP_DEACTIVATION_ACCEPT_CNT IS NULL AND B.PDP_DEACTIVATION_ACCEPT_CNT IS NULL THEN NULL ELSE IFNULL(A.PDP_DEACTIVATION_ACCEPT_CNT,0) + IFNULL(B.PDP_DEACTIVATION_ACCEPT_CNT,0) END AS PDP_DEACTIVATION_ACCEPT_CNT
			, CASE WHEN A.IRAT_HHO_FAILURE IS NULL AND B.IRAT_HHO_FAILURE IS NULL THEN NULL ELSE IFNULL(A.IRAT_HHO_FAILURE,0) + IFNULL(B.IRAT_HHO_FAILURE,0) END AS IRAT_HHO_FAILURE
...
-- 		AND A.UARFCN=B.UARFCN
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_end_dy_t
 		(DATA_DATE,INDOOR,MOVING,TILE_ID,RNC_ID,FREQUENCY, UARFCN, 
				CALL_TYPE,CALL_STATUS,CELL_NAME,CALL_CNT,CAUSE_14_CNT,CAUSE_15_CNT,CAUSE_46_CNT,CAUSE_115_CNT,CAUSE_OTHERS_CNT,
				CAUSE_53_CNT,CAUSE_65_CNT,CAUSE_114_CNT,CAUSE_263_CNT,CAUSE_CAPACITY,
				BEST_RSCP_1,BEST_ECN0_1,BEST_RSCP_1_MED,BEST_ECN0_1_MED,IRAT_HHO_ATTEMPT,IRAT_HHO_SUCCESS,POS_LAST_RSCP_CNT,POS_LAST_ECN0_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 				,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
...
-- 		AND A.UARFCN=B.UARFCN
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_end_dy_def
 		(DATA_DATE,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,
				CELL_ID,CELL_NAME,CALL_CNT,CAUSE_14_CNT,CAUSE_15_CNT,CAUSE_46_CNT,CAUSE_115_CNT,CAUSE_OTHERS_CNT,
				CAUSE_53_CNT,CAUSE_65_CNT,CAUSE_114_CNT,CAUSE_263_CNT,CAUSE_CAPACITY,
				BEST_RSCP_1,BEST_ECN0_1,BEST_RSCP_1_MED,BEST_ECN0_1_MED,IRAT_HHO_ATTEMPT,IRAT_HHO_SUCCESS, CELL_LON,CELL_LAT,POS_LAST_RSCP_CNT,POS_LAST_ECN0_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
...
-- 				,SUM(CALL_TYPE_PS) AS CALL_TYPE_PS
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_end_dy_c_def
 		(DATA_DATE,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,
				CELL_ID,CELL_NAME,CALL_CNT,CAUSE_14_CNT,CAUSE_15_CNT,CAUSE_46_CNT,CAUSE_115_CNT,CAUSE_OTHERS_CNT,
				CAUSE_53_CNT,CAUSE_65_CNT,CAUSE_114_CNT,CAUSE_263_CNT,CAUSE_CAPACITY,
				BEST_RSCP_1,BEST_ECN0_1,BEST_RSCP_1_MED,BEST_ECN0_1_MED,IRAT_HHO_ATTEMPT,IRAT_HHO_SUCCESS, CELL_LON,CELL_LAT,POS_LAST_RSCP_CNT,POS_LAST_ECN0_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
