...
-- 					  CALL_TYPE_PS MEDIUMINT(9) DEFAULT 0
	...
	SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,RUN,'.`tmp_table_tile_ue_',WORKER_ID,'`
			    (DATA_DATE,DATA_HOUR,INDOOR,MOVING,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,CALL_TYPE,CALL_STATUS,UE_CNT
...
-- 					, UARFCN
	...
	SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,RUN,'.table_tile_ue_c
			    (DATA_DATE,DATA_HOUR,INDOOR,MOVING,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,CALL_TYPE,CALL_STATUS,UE_CNT
				, CELL_LON,CELL_LAT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 				,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)	
...
-- 					, UARFCN
	...
	SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,RUN,'.table_tile_ue_def
			    (DATA_DATE,DATA_HOUR,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,UE_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 				,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)	
			    SELECT
...
-- 					,SUM(CALL_TYPE_PS) AS CALL_TYPE_PS
	...
	SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,RUN,'.table_tile_ue_c_def
			    (DATA_DATE,DATA_HOUR,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,UE_CNT
-- 				,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 				,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)	
			    SELECT
...
-- 					,SUM(CALL_TYPE_PS) AS CALL_TYPE_PS
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_ue_dy
 		(DATA_DATE,INDOOR,MOVING,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,CALL_TYPE,CALL_STATUS,UE_CNT
		,CELL_LON,CELL_LAT
-- 		,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 		,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)
...
-- 		AND A.UARFCN=B.UARFCN
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_ue_dy_c
 		(DATA_DATE,INDOOR,MOVING,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,CALL_TYPE,CALL_STATUS,UE_CNT
		,CELL_LON,CELL_LAT
-- 		,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 		,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)
...
-- 		AND A.UARFCN=B.UARFCN
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_ue_dy_def
 		(DATA_DATE,TILE_ID,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,UE_CNT
		,CELL_LON,CELL_LAT
-- 		,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 		,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)
...
-- 				,SUM(CALL_TYPE_PS) AS CALL_TYPE_PS
	...
	SET @SqlCmd=CONCAT('REPLACE INTO ',GT_DB,'.table_tile_ue_dy_c_def
 		(DATA_DATE,RNC_ID,CELL_INDOOR,CLUSTER_ID,SITE_ID,FREQUENCY,UARFCN,CELL_ID,CELL_NAME,UE_CNT
		,CELL_LON,CELL_LAT
-- 		,CALL_STATUS_BLOCK,CALL_STATUS_SUCCESS,CALL_STATUS_DROP,CALL_TYPE_SMS,CALL_TYPE_VOICE,CALL_TYPE_VEDIO
-- 		,CALL_TYPE_PS99,CALL_TYPE_HSPA,CALL_TYPE_MRAB,CALL_TYPE_PSOTHERS,CALL_TYPE_CS,CALL_TYPE_PS
	)
