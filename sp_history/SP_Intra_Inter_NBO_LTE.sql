...
BEGIN
	...
	SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,'.tmp_nbo_table_',WORKER_ID,' 
			(ENODEB_ID,CELL_ID,NBR_ENODEB_ID,NBR_CELL_ID,DATA_HOUR,HO_COUNT,PINGPONG_HO_CNT,HO_FAIL_CNT,HO_RE_EST_CNT,TA_HO_SUM,TA_HO_CNT) 
	...
	SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,'.opt_nbr_inter_intra_lte
			...
			SELECT 
				...
				NULL AS HO_INTERRUP_TIME,
				NULL AS HO_INTERRUP_CNT
	...
	EXECUTE Stmt;
	DEALLOCATE PREPARE Stmt;
	SET @SqlCmd=CONCAT('UPDATE ',GT_DB,'.opt_nbr_inter_intra_lte A, ',CURRENT_NT_DB,'.nt_cell_current_lte B
	...
	SET @SqlCmd=CONCAT('UPDATE ',GT_DB,'.opt_nbr_inter_intra_lte A, ',CURRENT_NT_DB,'.nt_cell_current_lte B
			SET A.NBR_CELL_NAME = B.CELL_NAME
			WHERE A.NBR_ENODEB_ID = B.ENODEB_ID AND A.NBR_CELL_ID = B.CELL_ID;');
	PREPARE Stmt FROM @SqlCmd;
	EXECUTE Stmt;
	DEALLOCATE PREPARE Stmt;
