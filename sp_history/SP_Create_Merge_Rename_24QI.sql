...
CREATE DEFINER=`covmo`@`%` PROCEDURE `SP_Create_Merge_Rename_24QI`(IN GT_DB VARCHAR(100),IN TBL_NAME VARCHAR(100), IN BOTTON_STR VARCHAR(100), IN SRC_TBL VARCHAR(100))
BEGIN
