...
BEGIN
	...
	SET @SqlCmd=CONCAT('CREATE TABLE ',GT_DB,'.`NT2_CELL_UMTS` (
				...
				`SITE_NAME` VARCHAR(50) CHARACTER SET UTF8,
				`CELL_ID` MEDIUMINT(9),
				`CELL_NAME` VARCHAR(50) CHARACTER SET UTF8,
				`SECTOR_ID` TINYINT(4),
				...
				`VENDOR_SITE_NAME` VARCHAR(50) CHARACTER SET UTF8,
	...
	SET @SqlCmd=CONCAT('CREATE TABLE ',GT_DB,'.`NT2_NBR_3_2_UMTS` (
				...
				`NBR_BSC_NAME` VARCHAR(50) CHARACTER SET UTF8,
				`NBR_LAC` MEDIUMINT,
				`NBR_CELL_ID` MEDIUMINT,
				`NBR_CELL_NAME` VARCHAR(50) CHARACTER SET UTF8,
				`PRIORITY` TINYINT,
	...
	SET @SqlCmd=CONCAT('CREATE TABLE ',GT_DB,'.`NT2_NBR_3_3_UMTS` (
				...
				`NBR_RNC_NAME` VARCHAR(50) CHARACTER SET UTF8,
				`NBR_CELL_ID` MEDIUMINT,
				`NBR_CELL_NAME` VARCHAR(50) CHARACTER SET UTF8,
				`PRIORITY` TINYINT,
				`NBR_TYPE` TINYINT,
	...
	CALL gt_gw_main.SP_Sub_Generate_Dim_Imsi_Group(GT_DB,'gt_covmo','umts');
END$$
DELIMITER ;
