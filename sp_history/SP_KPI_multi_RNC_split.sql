...
CREATE DEFINER=`covmo`@`%` PROCEDURE `SP_KPI_multi_RNC_split`(IN KPI_ID INT(11) ,IN PU VARCHAR(3000),IN START_DATE DATE,IN END_DATE DATE,IN START_HOUR TINYINT(2),IN END_HOUR TINYINT(2), IN SOURCE_TYPE TINYINT(2), IN SERVICE TINYINT(2)
