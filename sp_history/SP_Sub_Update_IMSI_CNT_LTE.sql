...
BEGIN
	...
	IF RTYPE = 'h' THEN
		...
		SET @SqlCmd=CONCAT('DROP TEMPORARY TABLE IF EXISTS ',GT_DB,'.tmp_cell_update_imsi','_',WORKER_ID,';');
		PREPARE Stmt FROM @SqlCmd;
		EXECUTE Stmt;
		DEALLOCATE PREPARE Stmt;
		
		SET @SqlCmd=CONCAT('CREATE TEMPORARY TABLE ',GT_DB,'.tmp_cell_update_imsi','_',WORKER_ID,' 
					(
		...
		SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,'.tmp_cell_update_imsi','_',WORKER_ID,'
				   SELECT
				  `DATA_DATE`,
				  `DATA_HOUR`,
				  `CALL_TYPE`,
		...
		SET @SqlCmd=CONCAT('UPDATE ',GT_DB,'.rpt_cell_start A ,',GT_DB,'.tmp_cell_update_imsi','_',WORKER_ID,' B
		...
		SET @SqlCmd=CONCAT('UPDATE ',GT_DB,'.rpt_cell_start_dy A ,',GT_DB,'.tmp_cell_update_imsi','_',WORKER_ID,' B
		...
		SET @SqlCmd=CONCAT('DROP TEMPORARY TABLE IF EXISTS ',GT_DB,'.tmp_cell_update_imsi_def','_',WORKER_ID,';');
		PREPARE Stmt FROM @SqlCmd;
		EXECUTE Stmt;
		DEALLOCATE PREPARE Stmt;
		SET @SqlCmd=CONCAT('CREATE TEMPORARY TABLE ',GT_DB,'.tmp_cell_update_imsi_def','_',WORKER_ID,' 
					(
						DATA_DATE DATE DEFAULT NULL,
						DATA_HOUR SMALLINT(6) DEFAULT NULL,
						SUB_REGION_ID MEDIUMINT(9) DEFAULT NULL,
		...
		SET @SqlCmd=CONCAT('INSERT INTO ',GT_DB,'.tmp_cell_update_imsi_def','_',WORKER_ID,'
				   SELECT
				  `DATA_DATE`,
				  `DATA_HOUR`,
				  `SUB_REGION_ID`,
		...
		SET @SqlCmd=CONCAT('UPDATE ',GT_DB,'.rpt_cell_start_def A ,',GT_DB,'.tmp_cell_update_imsi_def','_',WORKER_ID,' B
				    SET A.IMSI_CNT=IFNULL(B.IMSI_CNT,0)
				    WHERE A.DATA_DATE=B.DATA_DATE
				    AND A.DATA_HOUR=B.DATA_HOUR
				    AND A.SUB_REGION_ID=B.SUB_REGION_ID
		...
		SET @SqlCmd=CONCAT('UPDATE ',GT_DB,'.rpt_cell_start_dy_def A ,',GT_DB,'.tmp_cell_update_imsi_def','_',WORKER_ID,' B
				    SET A.IMSI_CNT=(CASE WHEN IFNULL(A.IMSI_CNT,0) > IFNULL(B.IMSI_CNT,0) THEN IFNULL(A.IMSI_CNT,0)
					WHEN IFNULL(A.IMSI_CNT,0) <= IFNULL(B.IMSI_CNT,0) THEN IFNULL(B.IMSI_CNT,0)
					END)
				    WHERE A.DATA_DATE=B.DATA_DATE
