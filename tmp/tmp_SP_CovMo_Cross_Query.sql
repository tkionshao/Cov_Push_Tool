CREATE DEFINER=`covmo`@`%` PROCEDURE `SP_CovMo_Cross_Query`(IN PU_ID VARCHAR(1000),IN START_DATE DATE,IN END_DATE DATE,IN sql_str LONGTEXT,IN V_WORK_ID INT(11),TECH_MASK TINYINT(4),IN PLOYGON_ID VARCHAR(100),IN IMSI_GID INT(11),IN CELL_GID INT(11),IN PRE_GROUP BIT,IN LIMIT_COUNT SMALLINT(6),IN LIMT_RAW_COUNT SMALLINT(6))
a_label:
BEGIN
